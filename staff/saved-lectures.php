...
<body>
     ...
     <div class="nav-wrapper" id="nav-wrapper">
      ...
      <?php
//echos each saved lecture
//each saved lecture will be presented on a 'card' - refer to materialize
//?filter property used to distiguish between each card
    ...
    <div class='card-reveal'>
      ...
      <p>$Description</p>
      <p>Date:$Date</p>
      <p><a href='delete-lectures.php?filter=$Projectid'>Delete this Lecture</a></p>
    </div>
  </div>";
