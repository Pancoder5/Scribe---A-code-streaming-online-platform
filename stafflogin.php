          ...
          <script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/js/materialize.min.js"></script>
           ...
           <div class="row">
                ...
                <form action="includes/loginstaff.inc.php" method="post">
                    <input type="text" name='staffuser' placeholder="Username">
                    <input type="password" name='staffpass' placeholder="Password">
                      <button class="btn waves-effect waves-light" type="submit" name="login-submitst">Login></button>
                    ...
                    <a href="registerstaff.php" class="waves-effect waves-light btn" type="submit" name="register-submit">Register</a>
